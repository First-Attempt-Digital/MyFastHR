...
import { Mail, Lock, Shield, Loader2, ArrowRight, Eye, EyeOff, Users, Home, Briefcase, Calendar, FileText, Heart, Search } from 'lucide-react';
...
const Login = () => {
    ...
    const [branding, setBranding] = useState(() => {
        ...
        return {
            ...
            login_subtitle: cachedAppName ? 'Please enter your administrator credentials to login.' : 'Welcome back! Please enter your administrator details.',
    ...
    const applyPortalBrandColor = (color) => {
        ...
        styleEl.innerHTML = `
            ...
            .bg-indigo-600, .bg-indigo-750, .bg-indigo-700:hover, .hover\\:bg-indigo-700:hover, .hover\\:bg-indigo-600:hover { background-color: ${color} !important; }
            .text-indigo-600, .text-indigo-650, .text-indigo-500, .text-indigo-655, .hover\\:text-indigo-600:hover, .hover\\:text-indigo-650:hover, .hover\\:text-indigo-655:hover { color: ${color} !important; }
                ...
                if (companySlug) {
                    ...
                    if (data) {
                        ...
                        setBranding({
                            ...
                            login_subtitle: 'Please enter your administrator credentials to login.',
                    ...
                    if (data) {
                        ...
                        setBranding({
                            ...
                            login_subtitle: data.login_subtitle || 'Welcome back! Please enter your administrator details.',
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            setError(apiMessage || 'Authentication Failed. Node is Unreachable.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="w-full min-h-screen lg:h-screen lg:overflow-hidden grid grid-cols-1 lg:grid-cols-12 bg-slate-50 font-outfit select-none">
            ...
            <div className="lg:col-span-6 h-full flex flex-col justify-between p-8 lg:p-12 bg-slate-50/50 relative z-10 shadow-xl shadow-slate-100 overflow-hidden">
                ...
                <div className="w-full max-w-[390px] mx-auto my-auto space-y-5 py-4 animate-in fade-in slide-in-from-bottom-4 duration-500 shrink-0">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    required
                                    placeholder="••••••••••••"
                                    className="w-full pl-12 pr-12 py-3 bg-white border border-slate-200 rounded-2xl text-sm font-semibold text-slate-850 placeholder:text-slate-355 focus:ring-4 focus:ring-indigo-500/5 focus:border-indigo-500 transition-all outline-none shadow-sm"
                                    value={password}
                        ...
                        <div className="flex items-center justify-between px-1 pt-1">
                            ...
                            <a href="#" className="text-xs font-bold text-indigo-655 hover:underline">Forgot password?</a>
                        </div>
                    ...
                    {/* Employee Switch Button */}
                    <button
                        onClick={() => navigate(companySlug ? `/employee/${companySlug}` : '/employee')}
                ...
                <div className="flex justify-between items-center text-[10px] font-bold text-slate-400 uppercase tracking-widest pt-4 border-t border-slate-200/40 shrink-0">
                    ...
                    <div className="flex items-center gap-1 font-mono">
                        <Shield size={12} className="text-slate-455" />
            ...
            <div className="lg:col-span-6 h-full hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-indigo-600 via-indigo-705 to-indigo-950 text-white relative overflow-hidden shrink-0">
                ...
                <div className="absolute right-[-15%] bottom-[-12%] w-[110%] max-w-[480px] aspect-[4/3] bg-slate-900 rounded-[28px] shadow-2xl p-2.5 border-4 border-slate-900/60 overflow-hidden rotate-[-3deg] select-none flex flex-col pointer-events-none">
