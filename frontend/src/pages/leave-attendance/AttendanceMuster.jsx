...
const AttendanceMuster = () => {
    ...
    const getStatusStyle = (status) => {
        switch (status) {
            ...
            case 'HD-PL':
                return 'bg-violet-50 text-violet-600 border border-violet-200/60 font-black';
            case 'HD-UL':
                return 'bg-fuchsia-50 text-fuchsia-600 border border-fuchsia-200/60 font-black';
            case 'NC':
    ...
    const getFullStatusName = (status) => {
        switch (status) {
            ...
            case 'HD-PL': return 'Half Day Paid Leave + Present';
            case 'HD-UL': return 'Half Day Unpaid Leave + Present';
